...
#ifndef GITIGNORE_BUNNY_EXAMPLE_H
#define GITIGNORE_BUNNY_EXAMPLE_H
...
namespace examples
{
    ...
    public:
        std::vector<std::string> outputFileNames ={
                ROBOCRAFT_DATA_FOLDER "/examples/bunny/zlandmark.json",
        };
    ...
    public:
        ...
        void runBenchMark()
        {
            ...
            {
                beamAssembly = std::make_shared<frame::FrameAssembly>();
                beamAssembly->loadFromJson(dataFolderString + "/bunny.json");
