...
#ifndef GITIGNORE_OPTIMIZATION_HOLISTIC_FIXEDSTEPLENGTH_H
#define GITIGNORE_OPTIMIZATION_HOLISTIC_FIXEDSTEPLENGTH_H
...
#endif //GITIGNORE_OPTIMIZATION_HOLISTIC_FIXEDSTEPLENGTH_H
