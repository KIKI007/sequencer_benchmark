...
#ifndef ROBO_CRAFT_FRAMETOSEQUENCESUM_H
#define ROBO_CRAFT_FRAMETOSEQUENCESUM_H
#include "FrameTO.h"
namespace dto
{
class FrameTOSequenceSum : public FrameTO
{
public:
...
public:
    ...
    FrameTOSequenceSum(const frame::FrameAssembly &assembly): FrameTO(assembly)
    {
...
#endif  //ROBO_CRAFT_FRAMETOSEQUENCE_H
