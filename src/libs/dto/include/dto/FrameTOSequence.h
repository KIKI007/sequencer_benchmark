...
#ifndef ROBO_CRAFT_FRAMETOSEQUENCE_H
#define ROBO_CRAFT_FRAMETOSEQUENCE_H
#include "FrameTO.h"
namespace dto
{
class FrameTOSequence : public FrameTO
{
public:
...
public:
    ...
    FrameTOSequence(const frame::FrameAssembly &assembly): FrameTO(assembly)
    {
...
public:
    ...
    int nX() override{return nE_dynamic() * nS() + 1;}
